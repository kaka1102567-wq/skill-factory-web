# multilingual-verify Specification

## Purpose
Enables P4 verification to use embedding-based similarity matching instead of keyword matching, supporting cross-language semantic verification (e.g., Vietnamese to English). Categorizes verification results into three tiers (verified, partially_verified, expert_insight) based on embedding scores while maintaining backward compatibility with keyword fallback.
