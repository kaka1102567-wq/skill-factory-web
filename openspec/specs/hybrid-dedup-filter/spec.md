# hybrid-dedup-filter Specification

## Purpose
Implements embedding-based pre-filtering in P3 deduplication to reduce redundant LLM calls. Classifies atom pairs into auto-merge (high similarity), uncertain (send to LLM), and unique zones using embedding similarity scores, while maintaining backward compatibility and LLM-based classification for nuanced semantic decisions.
