...
Distributing Python modules Publishing modules for use by other people
...
Last updated on: Feb 14, 2026 (17:11 UTC).
...
Optimize the dedent() function, improving performance by an average of 2.4x, with larger improvements for bigger inputs, and fix a bug with incomplete normalization of blank lines with whitespace characters other than space and tab.
